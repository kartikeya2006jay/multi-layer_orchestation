...
function ArchitectureShowcase() {
    const tabs = [
        {
            id: 'platform',
            title: 'The Moveworks AI Assistant Platform',
        ...
        {
            id: 'search',
            title: 'Search and action in one intuitive workspace',
        ...
        {
            id: 'engine',
            title: 'Powered by a superior Reasoning Engine',
        ...
        {
            id: 'easy',
            title: 'Easy to add and build AI agents for any use case',
